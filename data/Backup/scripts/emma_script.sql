...
-- -----------------------------------------------------
-- Table `mannequin_db`.`favoritos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mannequin_db`.`favoritos` ;

CREATE TABLE IF NOT EXISTS `mannequin_db`.`favoritos` (
...
-- -----------------------------------------------------
-- Table `mannequin_db`.`carrito`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mannequin_db`.`carrito` ;

CREATE TABLE IF NOT EXISTS `mannequin_db`.`carrito` (
  `products_idproducts` INT(11) NOT NULL,
  `sizes_idsizes` INT(11) NOT NULL,
  `users_idusers` INT(11) NOT NULL,
  PRIMARY KEY (`products_idproducts`, `sizes_idsizes`, `users_idusers`),
  INDEX `fk_products_has_sizes_has_users_users1_idx` (`users_idusers` ASC) ,
  INDEX `fk_products_has_sizes_has_users_products_has_sizes1_idx` (`products_idproducts` ASC, `sizes_idsizes` ASC) ,
  CONSTRAINT `fk_products_has_sizes_has_users_products_has_sizes1`
    FOREIGN KEY (`products_idproducts` , `sizes_idsizes`)
    REFERENCES `mannequin_db`.`products_has_sizes` (`products_idproducts` , `sizes_idsizes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_products_has_sizes_has_users_users1`
    FOREIGN KEY (`users_idusers`)
    REFERENCES `mannequin_db`.`users` (`idusers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
