...
CREATE TABLE IF NOT EXISTS `mannequin_db`.`users` (
  ...
  `genders_idgenders` INT(1) NULL DEFAULT NULL,
  ...
  `countries_idcountries` INT(11) NULL DEFAULT NULL,
  `telephone` INT(11) NULL DEFAULT NULL,
  `admin` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`idusers`, `genders_idgenders`, `countries_idcountries`),
...
CREATE TABLE IF NOT EXISTS `mannequin_db`.`cart_has_products` (
  ...
  `cart_users_idusers` INT(11) NOT NULL,
