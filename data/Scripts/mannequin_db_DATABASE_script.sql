...
CREATE TABLE IF NOT EXISTS `mannequin_db`.`products` (
  ...
  `discontinued_timpestamp` DATETIME ,
  `active` INT(1) NOT NULL DEFAULT 1,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mannequin_db`.`carts` ;

CREATE TABLE IF NOT EXISTS `mannequin_db`.`carts` (
  `users_idusers` INT(11) NOT NULL,
  `products_idproducts` INT(11) NOT NULL,
  `sizes_idsizes` INT(11) NOT NULL,
  ...
  INDEX `fk_cart_sizes1_idx` (`sizes_idsizes` ASC) ,
